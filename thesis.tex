...
\include{Intro/main}\cleardoublepage

\include{Physics/main}\cleardoublepage

\include{Instruments/main}\cleardoublepage

\include{Discrimination/main}\cleardoublepage

\include{Simulation/main}\cleardoublepage

\include{Fusion/main}\cleardoublepage

\include{Concl/conclusion}\cleardoublepage

\begin{appendices}
\input{Marsis/main}\cleardoublepage
\input{Passive/main}\cleardoublepage
\input{Ops/main.tex} % include doesn't work
\end{appendices}
%==========================================================================%
% Bibliography
\nolinenumbers
